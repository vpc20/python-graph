...
class TestGraph(TestCase):
    ...
    def test_get_weight(self):
        ...
        g.add_edge('b', 'c')
        g.add_edge('c', 'a')
        self.assertEqual(1, g.weight('a', 'b'))
        self.assertEqual(1, g.weight('b', 'a'))
        self.assertEqual(1, g.weight('b', 'c'))
        self.assertEqual(1, g.weight('c', 'b'))
        self.assertEqual(1, g.weight('c', 'a'))
        self.assertEqual(1, g.weight('a', 'c'))
        ...
        self.assertEqual(1, g.weight('a', 'b'))
        self.assertEqual(1, g.weight('b', 'a'))
        self.assertEqual(5, g.weight('b', 'c'))
        self.assertEqual(5, g.weight('c', 'b'))
        self.assertEqual(1, g.weight('c', 'a'))
        self.assertEqual(1, g.weight('a', 'c'))
    ...
    def test_add_vertex(self):
        ...
        g = Graph()
        g.add_vertex('a')
        self.assertEqual({'a': []}, g.adj)

        g = Graph()
        g.add_vertex('a')
        g.add_vertex('b')
        self.assertEqual({'a': [], 'b': []}, g.adj)

        g = Graph()
        g.add_vertex('a')
        g.add_vertex('b')
        g.add_vertex('c')
        self.assertEqual({'a': [], 'b': [], 'c': []}, g.adj)

    def test_add_edge(self):
        g = Graph()
        g.add_edge('a', 'b')
        self.assertEqual({'a': ['b'], 'b': ['a']}, g.adj)

        g = Graph()
        g.add_edge('a', 'b')
        g.add_edge('a', 'c')
        self.assertEqual({'a': ['b', 'c'], 'b': ['a'], 'c': ['a']}, g.adj)

        g = Graph()
        g.add_edge('a', 'b')
        g.add_edge('b', 'c')
        self.assertEqual({'a': ['b'], 'b': ['a', 'c'], 'c': ['b']}, g.adj)

        g = Graph()
        g.add_edge('a', 'b')
        g.add_edge('b', 'c')
        g.add_edge('c', 'a')
        self.assertEqual({'a': ['b', 'c'], 'b': ['a', 'c'], 'c': ['b', 'a']}, g.adj)
