...
class TestMst(TestCase):
    def test_mst(self):
        ...
        g.adj = {0: [2, 1], 2: [0, 3, 1], 1: [0, 2, 4, 3], 3: [2, 1, 4], 4: [1, 3]}
        ...
        g.adj = {0: [1, 3, 2, 4], 1: [0, 2, 4, 3], 3: [0, 2, 4, 1], 2: [1, 3, 0, 4], 4: [1, 3, 0, 2]}
        ...
        g.adj = {0: [1], 1: [0, 2, 6, 7], 2: [1, 3, 7, 8], 6: [1, 5, 7], 7: [1, 2, 6, 8], 3: [2, 4, 8],
        ...
        g.adj = {0: [1, 2], 1: [0, 2, 4, 3], 2: [0, 1, 3, 6], 4: [1, 3, 5], 3: [1, 2, 4, 6, 8, 7, 5], 6: [2, 3, 8],
